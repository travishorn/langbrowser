...
export const seed = async (knex) => {
  ...
  await knex("paradigms").insert([
    ...
    { name: "Concatenative", },
    { name: "Concurrent", description: "Concurrent programming deals with the design and implementation of software systems that can handle multiple tasks simultaneously. This paradigm provides the necessary tools and abstractions for writing programs that can run multiple tasks in parallel, making use of multiple processors or cores to speed up execution and improve performance.",    },
    { name: "Data-centric", },
    { name: "Data-driven" },
    { name: "Dataflow", },
    { name: "Declarative", },
    ...
    { name: "Distributed", description: "Distributed programming deals with the design and implementation of software systems that run on multiple computers, connected by a network. In this paradigm, a program is divided into multiple components that run on different machines, and communicate with each other to coordinate their activities.",    },
    { name: "Event-driven", description: "Event-driven programming is a software design paradigm in which the flow of the program is determined by events, or triggers, generated by user interactions, system events, or other inputs. In event-driven programming, the program is written as a set of event handlers, or callback functions, that are executed in response to events.",    },
    { name: "Extensible", },
    ...
    { name: "Generative", },
    { name: "Generic", description: "Generic programming is a software development paradigm in which algorithms and data structures are designed to handle values of various data types in a type-agnostic manner. This allows for greater reusability of code, as well as more efficient use of resources, as data structures and algorithms can be used with multiple data types without requiring separate implementations for each type.",    },
